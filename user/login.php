...
if(isset($_POST['login'])) 
  {
    ...
    $sql ="SELECT StuID,ID FROM tblsenior WHERE (UserName=:stuid || StuID=:stuid) and Password=:password";
            ...
            <div class="col-lg-4 mx-auto">
              <div class="auth-form-light text-left p-5">
                <div class="brand-logo">
                  <img src="images/sierralogo.jpg" style="margin: auto; display: block;">
                </div>   
                <h4 style=" text-align: center; font-size: 30px; color: #000000; font-family: Georgia, 'Times New Roman', Times, serif;">Senior Login</h4>
                <h6 class="font-weight-bold">Sign in to continue.</h6>
                <form class="pt-3" id="login" method="post" name="login">
                  <div class="form-group">
                    <input type="text" class="form-control form-control-lg" placeholder="enter your Seniors ID or Username" required="true" name="stuid" value="<?php if(isset($_COOKIE["user_login"])) { echo $_COOKIE["user_login"]; } ?>" >
                  </div>
                  <div class="form-group">
...
<div>
<a href="online-registration-form.php" style=" color: #000000;">Not registered yet? Register Now!</a>
</div>
