            ...
            <div class="auth-form-light text-left p-5">
              ...
              <form class="pt-3" id="login" method="post" name="login">
                <div class="form-group">
                  <input type="text" class="form-control form-control-lg" placeholder="enter your Seniors ID or Username" required="true" name="stuid" value="<?php if (isset($_COOKIE["user_login"])) {
