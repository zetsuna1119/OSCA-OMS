...
if (isset($_POST['submit'])) {
  ...
  $sql = "SELECT CitiEmail FROM tblsenior WHERE CitiEmail=:email and ContactNumber=:mobile";
  ...
  if ($query->rowCount() > 0) {
    $con = "update tblsenior set Password=:newpassword where CitiEmail=:email and ContactNumber=:mobile";
            ...
            <div class="auth-form-light text-left p-5">
              ...
              <form class="pt-3" id="login" method="post" name="login">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control form-control-lg" name="mobile" placeholder="Mobile Number" required="true" maxlength="11" pattern="[0-9]+">
                </div>
                <div class="form-group">
