        ...
        <div class="main-panel">
          <div class="content-wrapper">
             <div class="page-header">
              <h3 class="page-title"> Search Senior Citizens </h3>
                    ...
                    <form method="post">
                                <div class="form-group">
                                   <strong>Search Name:</strong>
                                    ...
                                    <input id="searchdata" type="text" name="searchdata" required="true" class="form-control" placeholder="Search by Senior Name"></div>
  ...
  <h4 align="center">Result against "<?php echo $sdata;?>" keyword </h4>
                    ...
                    <div class="table-responsive border rounded p-1">
                      ...
                      <table class="table">
                        <thead>
                          <tr>
                            <th class="font-weight-bold">Senior No.</th>
                            ...
                            <th class="font-weight-bold">Senior Email</th>
...
$sql="SELECT tblsenior.StuID,tblsenior.ID as sid,tblsenior.StudentName,tblsenior.StudentEmail,tblsenior.DateofAdmission,tblclass.ClassName,tblclass.Section from tblsenior join tblclass on tblclass.ID=tblsenior.StudentClass where tblsenior.SurName like '$sdata%' LIMIT $offset, $no_of_records_per_page";
$query = $dbh -> prepare($sql);
$query->execute();
