        ...
        <div class="main-panel">
          <div class="content-wrapper">
             <div class="page-header">
              <h3 class="page-title">Manage Waiting List </h3>
            ...
            <div class="row">
              ...
              $counter = 1;
							$stmt = $mysqli->prepare("SELECT `id`, `StuID`, `SurName`, `FirstName`, `MiddleName`, `Barangay`, `Gender`, `Age`, `DateofAdmission` FROM `tblonline_registration`  WHERE Status = 'Approved' ORDER BY `DateofAdmission` DESC LIMIT $offset, $total_records_per_page");
							$stmt->execute();
							$stmt->store_result();
							if( $stmt->num_rows > 0 ) {
                          ...
                          <td><?=$age?></td>
								          <td><?=$DateofAdmission?></td>
								              <td align="center">
									            <a href="edit-online-reg.php?id=<?=$id?>" class="btn btn-sm btn-success"><i class="fa fa-edit"></i>Approval</a>
