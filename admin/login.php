...
<html lang="en">
  <head>
    ...
    <title>Senior Citizen Profiling Management System|| Login Page</title>
    <!-- plugins:css -->
...
<h4 style=" text-align: center; font-size: 30px; color: #000000; font-family: Georgia, 'Times New Roman', Times, serif;">Admin Login</h4>
