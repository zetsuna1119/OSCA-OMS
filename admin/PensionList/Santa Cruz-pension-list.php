...
class PDF extends FPDF {
    ...
    function Header() {
        ...
        $this->Ln();
        $this->Cell(0, 5, 'BARANGAY SANTA CRUZ', 0, 0, 'C');
        $this->Ln();
...
$query = mysqli_query($con, "SELECT * FROM tblsenior  WHERE Barangay = 'Santa Cruz' ORDER BY `SurName`, `FirstName`, `MiddleName` ASC");
