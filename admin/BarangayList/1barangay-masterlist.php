...
class PDF extends FPDF {
    ...
    function Header() {
        ...
        $this->Ln();
        $this->Cell(0, 5, 'REGISTERED MASTERLIST', 0, 0, 'C');
        $this->Ln();
        $this->Cell(0, 5, 'As of _____________________20____', 0, 0, 'C');
        $this->Ln();
...
$query = mysqli_query($con, "SELECT * FROM tblsenior ORDER BY `SurName`, `FirstName`, `MiddleName` ASC");
