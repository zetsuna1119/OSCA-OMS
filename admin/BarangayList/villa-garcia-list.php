...
class PDF extends FPDF {
    ...
    function Header() {
        ...
        $this->Ln();
        $this->Cell(0, 5, 'BARANGAY VILLA GARCIA', 0, 0, 'C');
        $this->Ln();
...
$query = mysqli_query($con, "SELECT * FROM tblsenior  WHERE Barangay = 'Villa Garcia' ORDER BY `SurName`, `FirstName`, `MiddleName` ASC");
