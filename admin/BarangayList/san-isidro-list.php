...
class PDF extends FPDF {
    ...
    function Header() {
        ...
        $this->Ln();
        $this->Cell(0, 5, 'BARANGAY SAN ISIDRO', 0, 0, 'C');
        $this->Ln();
...
$query = mysqli_query($con, "SELECT * FROM tblsenior  WHERE Barangay = 'San Isidro' ORDER BY `SurName`, `FirstName`, `MiddleName` ASC");
