            ...
            <li class="nav-item">
              ...
              <div class="collapse" id="ui-basic2">
                <ul class="nav flex-column sub-menu">
                  ...
                  <li class="nav-item"> <a class="nav-link" href="checkbox_pension.php">No Pension</a></li>
                  <li class="nav-item"> <a class="nav-link" href="manage_no_pension.php">Manage No Pension</a></li>
                </ul>
              </div>
            </li>
