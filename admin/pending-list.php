        ...
        <div class="main-panel">
          <div class="content-wrapper">
             <div class="page-header">
              <h3 class="page-title">Online Application Pending List </h3>
            ...
            <div class="row">
                ...
                <div class="card">
                  <div class="card-body">
                    <!-- <div class="d-sm-flex align-items-center mb-4">
                      <a href="add_senior.php" class="btn btn-sm btn-primary"><i class="icon-plus"></i> Add New Senior</a>
                    </div> -->
              ...
              $counter = 1;
							$stmt = $mysqli->prepare("SELECT `id`, `SurName`, `FirstName`, `MiddleName`, `Barangay`, `Gender`, `Age`, `DateofAdmission`, `Status` FROM `tblonline_registration` WHERE `Status` = 'Pending' ORDER BY `DateofAdmission` DESC LIMIT $offset, $total_records_per_page");
							$stmt->execute();
							$stmt->store_result();
							if( $stmt->num_rows > 0 ) {
								$stmt->bind_result($id, $stuname, $fname, $mname, $barangay, $gender, $age, $DateofAdmission, $status );
								while( $stmt->fetch() ) {
                          ...
                          <td><?=$counter?></td>          
                                        ...
                                        <td style="color: red;" class="strupper1"><?=$status?></td>
								              <td align="center">
									            ...
									            <a href="delete-pending-list.php?id=<?=$id?>" class="btn btn-sm btn-danger" onclick="return confirm('Are you sure you want to delete?')"><i class="fa fa-trash"></i> Delete</a>
								              </td>
							      </tr>
                    <?php $counter++;?>
						<?php } } else {?>
