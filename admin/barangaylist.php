        ...
        <div class="main-panel">
          <div class="content-wrapper">
             <div class="page-header">
              <h3 class="page-title"> Manage Barangay List</h3>
                  ...
                  <div class="card-body">
                    <form method="post">
                                <div class="form-group">
                                   <strong>Search Registered Seniors by Barangay:</strong>
                                   <div class="form-group">


                      <input id="searchdata" type="text" name="searchdata" required="true" list="barangaylist" placeholder="Search by Barangay">
...
<!-- import to excel button -->
  <!-- <button type="submit" class="bttnimport" name="search" id="submit">Generate List</button> -->
...
$sql="SELECT * from tblsenior where tblsenior.Barangay like '$sdata%'  LIMIT $offset, $no_of_records_per_page";
...
{               ?>   
                          ...
                          <td><?php echo htmlentities($cnt);?></td>
                            ...
                            <td align="center">
									            <a href="barangay-list-edit.php?id=<?php echo htmlentities($row->ID);?>" class="btn btn-sm btn-success"><i class="fa fa-edit"></i> Edit</a>
