...
if (strlen($_SESSION['sturecmsaid']==0)) {
 ...
 $eid=$_GET['editid'];
$sql="update tblsenior set SurName=:stuname,MiddleName=:mname,FirstName=:fname,StudentEmail=:stuemail,StudentClass=:stuclass,Gender=:gender,DOB=:dob,StuID=:stuid,FatherName=:fname,MotherName=:mname,ContactNumber=:connum,AltenateNumber=:altconnum,Address=:address where ID=:eid";
...
{               ?>
                      <div class="form-group">
                        ...
                        <input type="text" name="stuname" value="<?php  echo htmlentities($row->SurName);?>" class="form-control" required='true'>
                      </div>
                      <div class="form-group">
