                ...
                <div class="card">
                  <div class="card-body">
                    <div class="d-sm-flex align-items-center mb-4">
                      <h4 class="card-title mb-sm-0">Manage Admin List</h4>
                      ...
                      <table class="table">
                        <thead>
                          <tr>
                            ...
                            <th  style="text-align: center" class="font-weight-bold">Admin Name</th>
                            <th class="font-weight-bold">User Name</th>
                            <th class="font-weight-bold">Mobile Number</th>
                            <th  style="text-align: center" class="font-weight-bold">Email</th>
...
{               ?>   
                          <tr>
                            ...
                            <td>
                              <div>
                                <a href="admin-list.php?delid=<?php echo ($row->ID);?>" onclick="return confirm('Do you really want to Delete ?');"> <i class="icon-trash"></i></a></div>
                            </td> 
                          </tr><?php $cnt=$cnt+1;}} ?>
                        </tbody>
                      </table>
